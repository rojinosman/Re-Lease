            ...
            {filteredListings.length === 0 ? (
                ...
                {filteredListings.map((listing) => (
                    ...
                    <div className="relative">
                        ...
                        />
                        <Badge className="absolute top-3 right-3 bg-green-500">Available {listing.available}</Badge>
                    </div>

                    <CardContent className="p-4">
                        <div className="flex justify-between items-start mb-2">
                        <h3 className="text-lg font-semibold truncate">{listing.title}</h3>
                        <span className="text-lg font-bold text-green-600">${listing.price}/mo</span>
                        </div>
